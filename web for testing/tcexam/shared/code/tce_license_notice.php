...
function F_displayLicenseNotice() {
    ...
    $notice = '<div style="direction:ltr;text-align:left;border:1px solid black; padding:5px; margin:10px; background-color:#DDEEFF; color:#003366; width:95%; margin-left:auto; margin-right:auto; font-weight:bold; font-size:95%;">';
