...
echo '<select name="test_id" id="test_id" class="searchable" size="0" onchange="document.getElementById(\'form_testeditor\').submit()" title="'.$l['h_test'].'">'.K_NEWLINE;
...
echo '</span>'.K_NEWLINE;
echo '<span class="formw">'.K_NEWLINE;
echo '<select name="user_groups[]" id="user_groups" class="searchable" size="5" multiple="multiple">'.K_NEWLINE;
...
echo '</span>'.K_NEWLINE;
echo '<span class="formw">'.K_NEWLINE;
echo '<select name="sslcerts[]" id="sslcerts" class="searchable" size="5" multiple="multiple">'.K_NEWLINE;
...
if (isset($test_id) and ($test_id > 0)) {
    ...
    echo '</span>'.K_NEWLINE;
    echo '<span class="formw">'.K_NEWLINE;
    echo '<select name="subject_id[]" id="subject_id" class="searchable" size="10" multiple="multiple" title="'.$l['h_subjects'].'">'.K_NEWLINE;
    // select subject_id
