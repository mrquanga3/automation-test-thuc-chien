...
echo '<select name="module_id" id="module_id" class="searchable" size="0" onchange="document.getElementById(\'form_moduleeditor\').submit()" title="'.$l['h_module_name'].'">'.K_NEWLINE;
...
$userids = array();
if ($_SESSION['session_user_level'] >= K_AUTH_ADMINISTRATOR) {
    echo '<select name="module_user_id" id="module_user_id" class="searchable" size="0" title="'.$l['h_module_owner'].'" onchange="">'.K_NEWLINE;
