...
require_once('../../shared/code/tce_license_notice.php');

// Display translatable license notice
F_displayLicenseNotice();
...
echo '<div style="color:#FFFFFF;">'.$l['d_admin_index'].'</div>';
