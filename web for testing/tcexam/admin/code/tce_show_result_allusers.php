...
echo '<select name="test_id" id="test_id" class="searchable" size="0" onchange="document.getElementById(\'form_resultallusers\').changecategory.value=1; document.getElementById(\'form_resultallusers\').submit()" title="'.$l['h_test'].'">'.K_NEWLINE;
...
echo '<select name="group_id" id="group_id" class="searchable" size="0">'.K_NEWLINE;
...
echo '<select name="user_id" id="user_id" class="searchable" size="0">'.K_NEWLINE;
