...
echo '<select name="subject_module_id" id="subject_module_id" class="searchable" size="0" onchange="document.getElementById(\'form_selectquestions\').changemodule.value=1;document.getElementById(\'form_selectquestions\').changecategory.value=1; document.getElementById(\'form_selectquestions\').submit();" title="'.$l['w_module'].'">'.K_NEWLINE;
...
echo '<select name="subject_id" id="subject_id" class="searchable" size="0" onchange="document.getElementById(\'form_selectquestions\').changecategory.value=1;document.getElementById(\'form_selectquestions\').submit()" title="'.$l['h_subject'].'">'.K_NEWLINE;
...
function F_show_select_questions($wherequery, $subject_module_id, $subject_id, $order_field, $orderdir, $firstrow, $rowsperpage, $hide_answers = false)
{
    ...
    if ($r = F_db_query($sql, $db)) {
        ...
        if (strlen($questlist) > 0) {
            ...
            echo '<select name="new_subject_id" id="new_subject_id" class="searchable" size="0" title="'.$l['h_subject'].'">'.K_NEWLINE;
