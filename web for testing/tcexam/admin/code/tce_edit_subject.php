...
echo '<select name="subject_module_id" id="subject_module_id" class="searchable" size="0" onchange="document.getElementById(\'form_subjecteditor\').changecategory.value=1; document.getElementById(\'form_subjecteditor\').submit();" title="'.$l['w_module'].'">'.K_NEWLINE;
...
echo '</span>'.K_NEWLINE;
echo '<span class="formw">'.K_NEWLINE;
echo '<select name="subject_id" id="subject_id" class="searchable" size="0" onchange="document.getElementById(\'form_subjecteditor\').submit()" title="'.$l['h_subject'].'">'.K_NEWLINE;
...
echo '<div class="row">'.K_NEWLINE;
echo '<span class="label">'.K_NEWLINE;
echo '<label for="subject_description">';
echo $l['w_description'];
if (isset($_REQUEST['ff_required']) and (strpos(','.$_REQUEST['ff_required'].',', ',subject_description,') !== false)) {
...
if (isset($_REQUEST['ff_required']) and (strpos(','.$_REQUEST['ff_required'].',', ',subject_description,') !== false)) {
    echo ' data-required="true" data-required-label="'.htmlspecialchars($l['w_description'], ENT_COMPAT, $l['a_meta_charset']).'"';
}
if (K_ENABLE_VIRTUAL_KEYBOARD) {
