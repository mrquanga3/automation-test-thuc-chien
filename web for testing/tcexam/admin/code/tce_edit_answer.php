...
switch ($menu_mode) {
    ...
    case 'forcedelete':{
        ...
        if ($menu_mode == 'delete') {
            ...
            // Bypass confirmation screen - set forcedelete to proceed
...
echo '<select name="subject_module_id" id="subject_module_id" class="searchable" size="0" onchange="document.getElementById(\'form_answereditor\').changemodule.value=1; document.getElementById(\'form_answereditor\').submit();" title="'.$l['w_module'].'">'.K_NEWLINE;
...
echo '<select name="question_subject_id" id="question_subject_id" class="searchable" size="0" onchange="document.getElementById(\'form_answereditor\').changesubject.value=1; document.getElementById(\'form_answereditor\').submit();" title="'.$l['h_subject'].'">'.K_NEWLINE;
...
echo '<select name="answer_question_id" id="answer_question_id" class="searchable" size="0" onchange="document.getElementById(\'form_answereditor\').changecategory.value=1; document.getElementById(\'form_answereditor\').submit()" title="'.$l['h_question'].'">'.K_NEWLINE;
...
echo '</span>'.K_NEWLINE;
echo '<span class="formw">'.K_NEWLINE;
echo '<select name="answer_id" id="answer_id" class="searchable" size="0" onchange="document.getElementById(\'form_answereditor\').submit()" title="'.$l['h_answer'].'">'.K_NEWLINE;
...
echo '<div class="row">'.K_NEWLINE;
echo '<span class="label">'.K_NEWLINE;
echo '<label for="answer_description">';
echo $l['w_answer'];
if (isset($_REQUEST['ff_required']) and (strpos(','.$_REQUEST['ff_required'].',', ',answer_description,') !== false)) {
...
if (isset($_REQUEST['ff_required']) and (strpos(','.$_REQUEST['ff_required'].',', ',answer_description,') !== false)) {
    echo ' data-required="true" data-required-label="'.htmlspecialchars($l['w_answer'], ENT_COMPAT, $l['a_meta_charset']).'"';
}
if (K_ENABLE_VIRTUAL_KEYBOARD) {
