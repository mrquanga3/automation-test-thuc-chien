...
echo '<select name="user_id" id="user_id" class="searchable" size="0" onchange="document.getElementById(\'form_usereditor\').submit()">'.K_NEWLINE;
...
$sql .= ' ORDER BY user_name, user_lastname, user_firstname';
if ($r = F_db_query($sql, $db)) {
