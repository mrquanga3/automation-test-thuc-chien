...
echo '<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="'.$l['a_meta_language'].'" lang="'.$l['a_meta_language'].'" dir="'.$l['a_meta_dir'].'" data-theme="light">'.K_NEWLINE;
...
echo '<link rel="stylesheet" href="'.$thispage_style.'?v='.time().'" type="text/css" />'.K_NEWLINE;
...
echo '<script type="text/javascript">window.EM = window.EM || { addEventListener: function(){}, removeEventListener: function(){}, dispatchEvent: function(){}, registerEvent: function(){ return { trigger: function(){} }; } };</script>'.K_NEWLINE;
echo '</head>'.K_NEWLINE;

echo '<body'.(isset($is_popup) && $is_popup ? ' class="popup-body"' : '').'>'.K_NEWLINE;
