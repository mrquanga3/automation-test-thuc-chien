...
$_['text_edit']             = 'Sửa Người Dùng';
$_['text_user']             = 'Thông Tin Người Dùng';
$_['text_password']         = 'Mật khẩu';
$_['text_other']            = 'Khác';
$_['text_login']            = 'Lịch Sử Đăng Nhập';
$_['text_authorize']        = 'Lịch Sử Xác Thực';
...
$_['error_login']           = 'Cảnh báo: Người dùng đăng nhập không tồn tại!';
...
$_['error_email_exists']    = 'Cảnh báo: Địa chỉ email đã được đăng ký!';
$_['error_password']        = 'Mật khẩu phải từ 4 đến 20 ký tự!';
$_['error_confirm']         = 'Mật khẩu và xác nhận mật khẩu không khớp!';
$_['error_edit_admin_inf']  = 'Không được phép chỉnh sửa tên đăng nhập/email/mật khẩu/trạng thái của tài khoản admin mặc định!';