...
$_['column_payment_method'] = 'Tên Thanh Toán';
$_['column_image']          = 'Hình Ảnh';
$_['column_type']           = 'Loại';
$_['column_date_expire']    = 'Ngày Hết Hạn';
...
// Help
$_['help_safe']             = 'Đặt thành true để tránh khách hàng này bị phát hiện bởi hệ thống chống gian lận';
$_['help_points']           = 'Dùng số âm để trừ điểm';
...
$_['error_customer']        = 'Cảnh báo: Khách hàng không tồn tại!';
$_['error_exists']          = 'Cảnh báo: Địa chỉ E-Mail đã được đăng ký!';
$_['error_address']         = 'Cảnh báo: Địa chỉ không tồn tại!';
...
$_['error_postcode']        = 'Mã bưu chính phải từ 2 đến 10 ký tự cho quốc gia này!';
$_['error_country']         = 'Vui lòng chọn quốc gia!';
$_['error_zone']            = 'Vui lòng chọn tỉnh / thành phố!';
$_['error_custom_field']    = '%s là bắt buộc!';
$_['error_regex']           = '%s không phải là dữ liệu nhập hợp lệ!';